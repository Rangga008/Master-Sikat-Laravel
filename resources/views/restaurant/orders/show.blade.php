...
\Log::info('Blade Payment Confirmation Check', [
    'order_id' => $order->id,
    'can_confirm' => $canConfirmPayment,
    'payment_method' => $order->payment_method,
    'payment_status' => $order->payment_status,
    'seller_confirmation_required' => $order->seller_confirmation_required,
...
<div class="bg-yellow-100 p-4 rounded">
    <p>Pembayaran tidak dapat dikonfirmasi saat ini.</p>
    <p>Kondisi yang dibutuhkan:</p>
    <ul>
        <li>Metode Pembayaran: Transfer</li>
        <li>Status Pembayaran: Pending</li>
        <li>Konfirmasi Penjual Diperlukan</li>
        <li>Bukti Pembayaran Ada</li>
    </ul>
</div>
@endif
